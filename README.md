...
Initial Install:
 ...
 - Clone the repo and run *bin/docker_build.sh* to create the Docker containers
...
Generate scrambles for new competition
 - Generate the scrambles using TNoodle and extract the resulting zip to the *scrambles/* folder
 - Run *bin/weekly_scrambles.sh* to process these new scrambles
 - Delete the zip and extracted contents
 - Edit *docs/scrambles.html* to use the new competition date at the end of the URL
...
New Sheet:
 ...
 - Edit *docs/responses.hml* to use this new URL
...
New Form:
 ...
 - Edit *docs/submit.html* to use this new URL
 - Edit *docs/analytics.html* to use the new URL but with "/viewanalytics" at the end instead of "/viewform"
